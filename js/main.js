...
function showSlides(n) {
    var slides = document.getElementsByClassName("mySlides"); // all elements with the class name "mySlides" and stores them in the variable array "slides"
    var dots = document.getElementsByClassName("dot"); // elements with the class name "dot" and stores them in the variable array "dots"
